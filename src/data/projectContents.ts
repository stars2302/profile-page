...
export const projectContents: ProjectContent[] = [
...

  {
    ...
    "name": "Kenya V3",
    "images": [],
    "description": "SI 프로젝트에서 공통으로 사용하는 Admin 프레임워크로, 프로젝트별 디자인 및 기능을 유연하게 커스터마이징할 수 있도록 구축한 공통 시스템입니다.",
  ...
  {
    "id": 2,
    "name": "KDIS Connect V2",
    "images": [],
    "description": "모바일 웹 기반 소셜 메신징 서비스 UI를 구축하고, 다양한 모바일 환경과 PC에서도 일관된 사용자 경험을 제공하도록 구현한 프로젝트입니다.",
  ...
  },
  {
    ...
    "name": "세기몰 유지보수",
    "images": [],
    "description": "온라인 쇼핑몰 운영 및 유지보수 프로젝트로, 이벤트·프로모션 페이지와 운영 기능을 지속적으로 개선하며 서비스를 관리한 프로젝트입니다.",
  ...
  {
    "id": 5,
    "name": "LS사우타 백운호수 Micro Grid EMS",
    "images": [],
    "description": "태양광(PV), ESS, 전력 제어, 전기차 충전소 등 다양한 에너지 설비의 상태와 운영 현황을 관리하는 에너지 관리 시스템(EMS)입니다.",
  ...
  },
  {
    ...
    "platform": ["Tablet"],
    "role": "키오스크 UI 마크업, vw 기반 반응형 화면 구성, Swiper 인터랙션 적용",
    "skills": [
      "Vue 3",
      "TypeScript",
      "SCSS",
  ...
  },
  {
    ...
    "name": "2D 설비/도면 에디터",
    "images": [],
    "description": "2D 설비와 도면을 편집할 수 있는 저작 도구로, 툴바, 속성 패널, 이벤트 편집, 태그 검색, 뷰포트 및 줌 기능 등을 제공하는 에디터입니다.",
